(function() {
    ...
    Browse.render = {};
    Browse.render.listingStatus = createStatusRenderer(LISTING_STATUS.enum, LISTING_STATUS.classes);
    Browse.render.itemCondition = createStatusRenderer(ITEM_CONDITION.enum, ITEM_CONDITION.classes);
    Browse.render.shippingPreference = function(value) {
