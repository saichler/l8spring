(function() {
    ...
    Deals.render = {};
    Deals.render.dealStatus = createStatusRenderer(DEAL_STATUS.enum, DEAL_STATUS.classes);
    Deals.render.disputeStatus = createStatusRenderer(DISPUTE_STATUS.enum, DISPUTE_STATUS.classes);
})();
